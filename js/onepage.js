! function e(t, i, s) {
    ...
    1: [function(e, t, i) {
        ...
        n = e("./env"), d = e("./routes"), c = e("./models/base-model"), h = e("./controllers/loader-controller"), o = e("./models/base-model"), s = e("./controllers/about-controller"), l = e("./models/base-model"), a = e("./controllers/landing-controller"), m = e("./models/base-model"), g = e("./controllers/work-controller"), p = e("./models/base-model"), u = e("./controllers/pages-controller"), r = function() {
            ...
            return t.prototype.routes = function() {
                ...
                for (HP.router.add("/", "Hannah Purmort - Design and Direction"), HP.router.add("/about", "Hannah Purmort - About"), r = HP.data.pages.work, e = 0, i = r.length; i > e; e++) o = r[e], HP.router.add("/" + o.slug, "Hannah Purmort - " + o.title);
                    ...
                    return function() {
                        return _.defer(function() {
                            return e.model.getE().addClass("totally-loaded").off(HP.utils.transition_end).one(HP.utils.transition_end, function() {
                                return e.$animated_logo.attr("style", ""), e.$animated_logo.attr("style", "background-image: url('/images/hannah-purmort-logo.gif?" + (new Date).getTime() + "')"), e.$instruct_inner.addClass("no-trans"), e.activate()
                            })
                        })
                    }
                }(this))
        ...
        s = function() {
            ...
            return e.prototype.build = function() {
                ...
                return this.model.setV($(JST["work-detail-page"](_.findWhere(HP.data.pages.work, {
                    ...
                    slug: this.id
                }), i !== HP.data.pages.work.length - 1 ? (t = HP.data.pages.work[i + 1].slug, e = "<div class='roller-part'><div class='lava-link passage' data-href='/" + t + "'><h4>Next: " + HP.data.pages.work[i + 1].title + "<span class='tick'></span></h4></div></div>", $(".pagination", this.model.getE()).append(e)) : $(".pagination", this.model.getE()).remove()
            }, e.prototype.loadImages = function() {
    ...
    8: [function(e, t, i) {
        ...
        s = {
            loading: {
                copy: "I&rsquo;m a Digital Designer and Art Director.<br><span>Scroll down to view some of<br>my creative work.</span>"
            },
            pages: {
                about: {
                    pullquote: ["Believing in genuine design â€“ I work", "to find creative solutions that ignite", "change, improve quality of life, and", "foster enduring relationships between", "brands and their clients."],
                    alt_quote: "Believing in genuine design â€“ I work to find creative solutions that ignite change, improve quality of life, and foster enduring relationships between brands and their clients.",
                    sub_quote: ["With a focus in Branding and Art Direction, I strive to create lasting", "connections with people through meaningful and deliberate design.", "Let's build something together."],
                    alt_sub_quote: "With a focus in Branding and Art Direction, I strive to create lasting connections with people through meaningful and deliberate design.<br>Let's build something together.",
                    email: "hpurmort@gmail.com",
                    socials: [{
                        name: "Instagram",
                        link: "https://instagram.com/hannah_purmort"
                    }, {
                        name: "Vimeo",
                        link: "https://vimeo.com/user3137021"
                    }, {
                        name: "Behance",
                        link: "https://behance.net/Hannahpurmort"
                    }, {
                        name: "Pinterest",
                        link: "https://pinterest.com/hnnh/pins"
                    }, {
                        name: "LinkedIn",
                        link: "https://linkedin.com/pub/hannah-purmort/3a/358/895"
                    }]
                },
                work: [{
                    slug: "johnson-nathan-strohe",
                    title: "Johnson Nathan Strohe",
                    category: "Branding",
                    role: "Creative Direction &amp; Design",
                    poster: ["/images/work/johnson-nathan-strohe/poster.jpg", "/images/work/johnson-nathan-strohe/feature.jpg"],
                    description: "Johnson Nathan Strohe is an award winning architectural firm that has been shaping the urban landscape of Colorado for over 20 years. The firm came to me with the challenge of rebranding the company from JG Johnson Architects to Johnson Nathan Strohe - marking a shift in internal leadership, and also to better reflect their progressive vision and increasingly diverse client base. I worked closely with Director of Brand Strategy, Roberta Reis, to achieve a new identity that retains a sense of equity and traditional values, but also reflects their progressive and modern vision. The new visual identity offers JNS the competitive edge they need to compete in an increasingly saturated market, and also thrive in the booming economy that is Denver, Colorado - one of the most rapidly developing cities in the United States.",
                    website: "http://jns.design",
                    media: [{
                        type: "image",
                        ...
                        type: "image",
                        src: "/images/work/johnson-nathan-strohe/003_JNS.jpg",
                        size: [1200, 800]
                    }, {
                        type: "image",
                        src: "/images/work/johnson-nathan-strohe/004_JNS.jpg",
                        size: [1200, 736]
                    }, {
                        type: "image",
                        src: "/images/work/johnson-nathan-strohe/005_JNS.jpg",
                        size: [1200, 630]
                    }]
                }, {
                    slug: "bear-creek-distillery",
                    title: "Bear Creek Distillery",
                    category: "Branding &amp; Package Design",
                    role: "Creative Direction &amp; Design",
                    poster: ["/images/work/bear-creek-distillery/poster.jpg", "/images/work/bear-creek-distillery/feature.jpg"],
                    description: "Armed with nothing but honest ingredients and pure passion for small batch spirits, Bear Creek Distillery is quickly gearing up to make a big splash in the rapidly growing Colorado craft spirit scene. The Bear Creek identity is clean and modern in style - much like the way a fine whiskey takes on its unique character and flavor profile after being distilled, the shape of the bear icon has itself been distilled down to only its essential features and lines. Both the product and the brand capture the spirit of the West and what it means to be uniquely from Colorado.",
                    website: "http://bearcreekdistillery.com",
                    credits: [{
                        copy: "Web Design &amp; Development",
                        link: "http://enterthegrave.com",
                        name: "Grave"
                    }],
                    media: [{
                        type: "image",
                        src: "/images/work/bear-creek-distillery/001bearcreek.jpg",
                        size: [1185, 790]
                    }, {
                        type: "image",
                        src: "/images/work/bear-creek-distillery/002bearcreek.jpg",
                        size: [1200, 640]
                    }, {
                        type: "image",
                        src: "/images/work/bear-creek-distillery/003_BCD.jpg",
                        size: [1200, 613]
                    }, {
                        type: "image",
                        src: "/images/work/bear-creek-distillery/004_BCD.jpg",
                        size: [1200, 300]
                    }, {
                        type: "image",
                        src: "/images/work/bear-creek-distillery/bearcreek0.jpg",
                        size: [1200, 603]
                    }, {
                        type: "image",
                        src: "/images/work/bear-creek-distillery/bearcreek1.jpg",
                        size: [1200, 603]
                    }, {
                        type: "image",
                        src: "/images/work/bear-creek-distillery/bearcreek07.jpg",
                        size: [1200, 514]
                    }, {
                        type: "image",
                        src: "/images/work/bear-creek-distillery/bearcreek05.jpg",
                        size: [1200, 765]
                    }, {
                        type: "image",
                        src: "/images/work/bear-creek-distillery/bearcreek09.jpg",
                        size: [1238, 696]
                    }, {
                        type: "image",
                        src: "/images/work/bear-creek-distillery/bearcreek10.jpg",
                        size: [1123, 632]
                    }, {
                        type: "image",
                        src: "/images/work/bear-creek-distillery/002_bcdcask.jpg",
                        size: [978, 483]
                    }]
                }, {
                    slug: "menagerie",
                    ...
                    category: "Branding",
                    role: "Creative Direction &amp; Design",
                    poster: ["/images/work/menagerie/poster.jpg", "/images/work/menagerie/feature.jpg"],
                    description: "An artful collection of strange and diverse objects - the definition of Menagerie. Founder, Andy Raether, is a world class climber and entrepreneur. He started Menagerie out of a deep appreciation for the natural world and the simple desire to climb with better holds. Fusing both artful form and unyielding function, Raether's unique climbing holds are inspired by nature and refined through meticulous research and design. The brand needed to embody this delicate balance between aesthetics and engineering, while at the same time appeal to climbers of many different skill levels and backgrounds. Since launching in 2013, Menagerie has seen incredible growth and has become a leading brand in the world of indoor climbing. Their bold shapes are shipped all over the world and enjoyed by climbers who share a similar passion for artful expression through this demanding sport. Menagerie encourages people to climb like no one is watching!",
                    website: "http://menagerieclimb.com",
                    credits: [{
                        copy: "Web Design &amp; Development",
                        link: "http://youngandhungry.co",
                        name: "Young &amp; Hungry"
                    }],
                    media: [{
                        type: "image",
                        src: "/images/work/menagerie/2a_MENAGERIE.jpg",
                        size: [1200, 613]
                    }, {
                        type: "image",
                        src: "/images/work/menagerie/3_MENAGERIE.jpg",
                        size: [1200, 476]
                    }, {
                        type: "image",
                        src: "/images/work/menagerie/4_MENAGERIE.jpg",
                        size: [819, 327]
                    }, {
                        type: "image",
                        src: "/images/work/menagerie/1.jpg",
                        size: [1200, 606]
                    }]
                }, {
                    slug: "roniit",
                    ...
                    role: "Creative Direction &amp; Design",
                    poster: ["/images/work/roniit/poster.jpg", "/images/work/roniit/feature.jpg"],
                    description: "Roniit is quickly making a name for herself in the musical realm of Dark Pop. She has an international fan base who share an appreciation for the darker things in life. Roniit has relied on me on a consistent basis for the past several years to fulfill her branding and visual needs as an alternative musical artist. I have completed a multitude of different projects for Roniit, the most prominent being the design of her personal website and most recent music video for the song 'Runaway'. The website needed to be versatile, lightweight, and reflective of her unique style of music. The landing page features timed full page announcements for things such as new music releases or press. A fully interactive photo gallery and tour schedule was also integrated. Working with developer, Keith Driessen, we built an immersive web experience for her fans, along with ensuring seamless mobile integration. In addition to aiding in the digital aspects of her brand, I have also helped in developing her photographic representation. I recently directed and conceptualized the music video for her latest single, 'Runaway'. With months of planning, a limited budget, and only one day allotted for filming, the final result is a beautifully dark expression that has fueled her career and elevated her perception as an emerging force to be reckoned with.",
                    website: "http://roniit.com",
                    credits: [{
                        copy: "Cinematography",
                        link: "http://lukeaskelson.com",
                        name: "Luke Askelson"
                    }, {
                        copy: "Web Design &amp; Development",
                        link: "http://enterthegrave.com",
                    ...
                    recognition: [{
                        ...
                        link: "http://www.interviewmagazine.com/music/exclusive-video-premiere-runaway-roniit",
                        text: "Read Article"
                    }],
                    media: [{
                        type: "image",
                        src: "/images/work/roniit/Project-img_roniit-00.png",
                        size: [1200, 898]
                    }, {
                        type: "image",
                        src: "/images/work/roniit/Project-img_roniit-000.png",
                        size: [1200, 898]
                    }, {
                        type: "image",
                        src: "/images/work/roniit/Project-img_roniit-000a.png",
                        size: [1200, 898]
                    }, {
                        type: "image",
                        src: "/images/work/roniit/Project-img_roniit-000b.png",
                        size: [1200, 898]
                    }, {
                        type: "image",
                        src: "/images/work/roniit/Project-img_roniit-000c.png",
                        size: [1200, 898]
                    }, {
                        type: "image",
                        src: "/images/work/roniit/Project-img_roniit-000d.png",
                        size: [1200, 710]
                    }, {
                        type: "image",
                        src: "/images/work/roniit/Project-img_roniit-001.jpg",
                        size: [1200, 527]
                    }, {
                        type: "image",
                        src: "/images/work/roniit/Project-img_roniit-002.jpg",
                        size: [1200, 527]
                    }, {
                        type: "image",
                        src: "/images/work/roniit/Project-img_roniit-003.jpg",
                        size: [1200, 527]
                    }, {
                        type: "image",
                        src: "/images/work/roniit/Project-img_roniit-004.jpg",
                        size: [1200, 527]
                    }, {
                        type: "image",
                        src: "/images/work/roniit/Project-img_roniit-005.jpg",
                        size: [1200, 527]
                    }, {
                        type: "image",
                        src: "/images/work/roniit/Project-img_roniit-006.png",
                        size: [1200, 790]
                    }, {
                        type: "image",
                        src: "/images/work/roniit/Project-img_roniit-007.png",
                        size: [1200, 900]
                    }, {
                        type: "video",
                        id: "143157113",
                        src: "/images/work/roniit/roniit-video-poster.jpg",
                        size: [1280, 720]
                    }]
                }, {
                    slug: "mind-frame-cinema",
                    title: "Mind Frame Cinema",
                    category: "Branding",
                    role: "Art Direction &amp; Design",
                    poster: ["/images/work/mind-frame-cinema/poster.jpg", "/images/work/mind-frame-cinema/feature.jpg"],
                    description: "Mind Frame Cinema is the creation of Nelson Carayannis, a forward-thinking individual who is passionate about making films. He came to me looking for an identity that was modern, clean and could translate well across a variety of digital and physical platforms (Film frame courtesy of Nelson Carayannis).",
                    website: "http://mindframecinema.com",
                    credits: [{
                        copy: "Web Design &amp; Development",
                        link: "http://enterthegrave.com",
                        name: "Grave"
                    ...
                    media: [{
                        type: "image",
                        src: "/images/work/mind-frame-cinema/01.jpg",
                        size: [1200, 450]
                    }, {
                        type: "image",
                        src: "/images/work/mind-frame-cinema/02.jpg",
                        size: [1200, 523]
                    }, {
                        type: "image",
                        src: "/images/work/mind-frame-cinema/mfcard.jpg",
                        size: [800, 450]
                    }, {
                        type: "image",
                        src: "/images/work/mind-frame-cinema/mffont.jpg",
                        size: [1200, 603]
                    }, {
                        type: "image",
                        src: "/images/work/mind-frame-cinema/mindframe04.jpg",
                        size: [1175, 508]
                    }]
                }, {
                    slug: "the-cabinet",
                    ...
                    category: "Motion",
                    role: "Art Direction",
                    poster: ["/images/work/the-cabinet/poster.jpg", "/images/work/the-cabinet/feature.jpg"],
                    description: "The Cabinet of Creatives was initially created for the purpose of merging three creative agencies under a single moniker. Along with developing a visual identity for The Cabinet I was responsible for Art Direction for the website and various branding materials. We developed a splash video for the website in an effort to communicate the tone and personality of the brand. Much like the different parts that are required to complete a finely tailored suit, a good creative agency is a well-oiled machine of many different moving pieces. In order to succeed, everything must come together in a seamless fashion.",
                    credits: [{
                        copy: "Cinematography",
                        link: "http://lukeaskelson.com",
                        name: "Luke Askelson"
                    ...
                    recognition: [{
                        title: "2013 ADCD Award for Design - Brand Development"
                    }],
                    media: [{
                        type: "video",
                        id: "143343327",
                        src: "/images/work/the-cabinet/the-cabinet-video-poster.jpg",
                        size: [1280, 720]
                    }, {
                        type: "image",
                        src: "/images/work/the-cabinet/Project-img_001.jpg",
                        size: [1200, 674]
                    }, {
                        type: "image",
                        src: "/images/work/the-cabinet/Project-img_001a.jpg",
                        size: [1200, 674]
                    }, {
                        type: "image",
                        src: "/images/work/the-cabinet/Project-img_002.jpg",
                        size: [1200, 674]
                    }, {
                        type: "image",
                        src: "/images/work/the-cabinet/Project-img_003.jpg",
                        size: [1200, 674]
                    }, {
                        type: "image",
                        src: "/images/work/the-cabinet/Project-img_004.jpg",
                        size: [1200, 674]
                    }]
                }, {
                    slug: "tenin",
                    ...
                    category: "Branding",
                    role: "Art Direction &amp; Design",
                    poster: ["/images/work/tenin/poster.jpg", "/images/work/tenin/feature.jpg"],
                    description: "Tenin offers custom timepieces that are tailored to the modern gentleman. Each Tenin watch is built by hand by founder and watchmaker, Paul Krucke, and features fully mechanical functionality. The original logo was concepted by Krucke himself. The mark not only mimicks a key mechanical part in the watch, but is also a typographic expression - each letter in the logo (T-E-N-I-N) can be found subtly whithin this simple mark. He approached me to refine what he had laid the foundation for and to build out a complete visual identity system for the brand. The final product is a brand that appeals directly to patrons who have an undeniable appreciation for bespoke timepieces and the mechanics under the surface that make them tick.",
                    credits: [{
                        copy: "Concept and Initial Logo Design",
                        name: "Paul Krucke"
                    }],
                    media: [{
                        type: "image",
                        src: "/images/work/tenin/00_tenin.jpg",
                        size: [1282, 880]
                    }, {
                        type: "image",
                        src: "/images/work/tenin/000_tenin.jpg",
                        size: [1282, 653]
                    }, {
                        type: "image",
                        src: "/images/work/tenin/001_tenin.jpg",
                        size: [1282, 653]
                    }, {
                        type: "image",
                        src: "/images/work/tenin/003_tenin.jpg",
                        size: [1200, 610]
                    }, {
                        type: "image",
                        src: "/images/work/tenin/004_tenin.jpg",
                        size: [1200, 724]
                    }, {
                        type: "image",
                        src: "/images/work/tenin/005_tenin.jpg",
                        size: [1200, 775]
                    }, {
                        type: "image",
                        src: "/images/work/tenin/usb1.jpg",
                        size: [1200, 662]
                    }, {
                        type: "image",
                        src: "/images/work/tenin/usb2.jpg",
                        size: [1200, 662]
                    }]
                }, {
                    slug: "clarkson-creative",
                    title: "Clarkson Creative",
                    category: "Branding",
                    role: "Design",
                    poster: ["/images/work/clarkson-creative/poster.jpg", "/images/work/clarkson-creative/feature.jpg"],
                    description: "Rich Clarkson is an award-winning photographer and photojournalist who has been documenting the world of professional sports for over fifty years. Clarkson was in need of a brand that embodied a prolific and decorated past, while also serving a progressive vision. The brand I created for his accomplished agency won the 2014 Art Directors Club of Denver award for excellence in branding.",
                    website: "http://clarkson-creative.com",
                    credits: [{
                        copy: "Creative Direction",
                        link: "http://cinearc.com",
                        name: "Charles Hellwig"
                    }, {
                        copy: "Web Design",
                        name: "Patty Toner"
                    }],
                    recognition: [{
                        title: "2014 ADCD Award for Design - Brand Development"
                    }],
                    media: [{
                        type: "image",
                        src: "/images/work/clarkson-creative/001_CC.jpg",
                        size: [1200, 750]
                    }, {
                        type: "image",
                        src: "/images/work/clarkson-creative/002_CC.jpg",
                        size: [1200, 538]
                    }, {
                        type: "image",
                        src: "/images/work/clarkson-creative/002a_CC.jpg",
                        size: [1200, 648]
                    }, {
                        type: "image",
                        src: "/images/work/clarkson-creative/003_CC.jpg",
                        size: [1200, 800]
                    }]
                }, {
                    slug: "re-source",
                    ...
                    role: "Design",
                    poster: ["/images/work/re-source/poster.jpg", "/images/work/re-source/feature.jpg"],
                    description: "My senior thesis at the University of Colorado revolved around the issue of waterborne illness in Africa, and how design can affect and inspire charity among the wealthy. Over a four month period, I sought to discover how I could utilize aspects of branding and print design to create an informative campaign targeted towards the wealthiest percentage of Americans, in order to inspire donations that can help alleviate water-borne illness in Africa. I partnered with Project Education South Sudan in order to gain insight to the situation in South Sudan, which provided the content I needed to create an informative printed and hand-stitched booklet. The end result was an interactive print-based installation at Redline Gallery in Denver that aimed to challenge people's perception of wealth and what it means for cultures other than our own.",
                    media: [{
                        type: "image",
                        src: "/images/work/re-source/01.jpg",
                        size: [1200, 635]
                    }, {
                        type: "image",
                        src: "/images/work/re-source/02.jpg",
                        size: [1200, 797]
                    }, {
                        type: "image",
                        src: "/images/work/re-source/03.jpg",
                        size: [1200, 797]
                    }, {
                        type: "image",
                        src: "/images/work/re-source/04.jpg",
                        size: [1200, 797]
                    }, {
                        type: "image",
                        src: "/images/work/re-source/05.jpg",
                        size: [1200, 797]
                    }, {
                        type: "image",
                        src: "/images/work/re-source/06.jpg",
                        size: [1200, 797]
                    }, {
                        type: "image",
                        src: "/images/work/re-source/07.jpg",
                        size: [1200, 800]
                    }, {
                        type: "image",
                        src: "/images/work/re-source/08.jpg",
                        size: [1200, 797]
                    }, {
                        type: "image",
                        src: "/images/work/re-source/09.jpg",
                        size: [1200, 800]
                    }, {
                        type: "image",
                        src: "/images/work/re-source/10.jpg",
                        size: [1200, 550]
                    }, {
                        type: "image",
                        src: "/images/work/re-source/11.jpg",
                        size: [1200, 635]
                    }, {
                        type: "image",
                        src: "/images/work/re-source/icons.jpg",
                        size: [1200, 572]
                    }]
                }, {
                    slug: "cinearc",
                    ...
                    poster: ["/images/work/cinearc/poster.jpg", "/images/work/cinearc/feature.jpg"],
                    description: "The Cinearc Agency approached me when looking for a full redesign of their web presence. Cinearc is a design agency that works with many different professional sectors â€“ architecture, fashion, broadcast, automotive, and hospitality - and in a variety of different media. The new site needed to feature all of their work in a simple and organized way so as to offer a comprehensive view of what Cinearc is capable of. Collaborating with developer Keith Driessen, we were able to create an interface that could feature the myriad of different projects that Cinearc produces in a lightweight and agile fashion.",
                    website: "http://cinearc.com",
                    media: [{
                        type: "image",
                        src: "/images/work/cinearc/001a_web.png",
                        size: [1200, 898]
                    }, {
                        type: "image",
                        src: "/images/work/cinearc/002_web.png",
                        size: [1200, 898]
                    }, {
                        type: "image",
                        src: "/images/work/cinearc/003_web.png",
                        size: [1200, 898]
                    }, {
                        type: "image",
                        src: "/images/work/cinearc/cinearc09.jpg",
                        size: [1200, 828]
                    }, {
                        type: "image",
                        src: "/images/work/cinearc/cinearc09a.jpg",
                        size: [1200, 882]
                    }, {
                        type: "image",
                        src: "/images/work/cinearc/cinearc10.jpg",
                        size: [1200, 828]
                    }]
                }, {
                    slug: "antiis",
                    ...
                    role: "Art Direction &amp; Design",
                    poster: ["/images/work/antiis/poster.jpg", "/images/work/antiis/feature.jpg"],
                    description: "Antiis was a particular favorite amongst the many projects I completed during my time in the University of Colorado's Digital Design Program. Having only the option of branding Heaven or Hell, I chose the later and created Antiis. The project involved developing a brand identity, along with a philosophy, brand guidelines, screen-printed apparel, and a brand bible / book. This was one of my first experiences in Art Direction. From dictating the look and feel of the brand, to organizing and directing the photoshoot - I had a lot of fun with this one.",
                    media: [{
                        type: "image",
                        src: "/images/work/antiis/antiis01.jpg",
                        size: [1200, 840]
                    }, {
                        type: "image",
                        src: "/images/work/antiis/antiis02.jpg",
                        size: [1200, 840]
                    }, {
                        type: "image",
                        src: "/images/work/antiis/antiis03.jpg",
                        size: [1200, 840]
                    }, {
                        type: "image",
                        src: "/images/work/antiis/antiis04.jpg",
                        size: [1200, 840]
                    }, {
                        type: "image",
                        src: "/images/work/antiis/antiis05.jpg",
                        size: [1200, 840]
                    }, {
                        type: "image",
                        src: "/images/work/antiis/antiis06.jpg",
                        size: [1200, 772]
                    }]
                }, {
                    slug: "drom",
                    ...
                    category: "Branding",
                    role: "Art Direction &amp; Design",
                    poster: ["/images/work/drom/poster.jpg", "/images/work/drom/feature.jpg"],
                    description: "DrÃ¸m Studio is the creation of Alexis Johnston, an editor, photographer and model. An ambitious and multi-talented individual, Alexis was looking for a brand that could help fulfill her goals of building a production company that blurs the lines between fashion, film, and conceptual design (Photo courtesy of Alexis Johnston).",
                    media: [{
                        type: "image",
                        src: "/images/work/drom/drom2.jpg",
                        size: [1200, 800]
                    }, {
                        type: "image",
                        src: "/images/work/drom/drom3.jpg",
                        size: [1200, 450]
                    }, {
                        type: "image",
                        src: "/images/work/drom/drom4.jpg",
                        size: [1200, 800]
                    }, {
                        type: "image",
                        src: "/images/work/drom/model.jpg",
                        size: [1200, 664]
                    }]
                }, {
                    slug: "kia",
                    ...
                    category: "Motion",
                    role: "Art Direction",
                    poster: ["/images/work/kia/poster.jpg", "/images/work/kia/feature.jpg"],
                    description: "This commercial for the new KIA RIO 5-Door was a collaborative effort between Denver-based studios: Meme, Cinearc, and Definite Productions. As a lead designer at the Cinearc Agency, my role in creating this spot involved Art Direction, storyboarding, and post production.",
                    media: [{
                        type: "video",
                        id: "60794045",
                        src: "/images/work/kia/kia-video-poster.jpg",
                        size: [1280, 720]
                    }, {
                        type: "image",
                        src: "/images/work/kia/02.jpg",
                        size: [1200, 500]
                    }, {
                        type: "image",
                        src: "/images/work/kia/03.jpg",
                        size: [1200, 600]
                    }, {
                        type: "image",
                        src: "/images/work/kia/04.jpg",
                        size: [1200, 600]
                    }, {
                        type: "image",
                        src: "/images/work/kia/05.jpg",
                        size: [1200, 600]
                    }, {
                        type: "image",
                        src: "/images/work/kia/06.jpg",
                        size: [1200, 600]
                    }]
                }, {
                    slug: "mimo",
                    ...
                    category: "Branding",
                    role: "Design",
                    poster: ["/images/work/mimo/poster.jpg", "/images/work/mimo/feature.jpg"],
                    description: "The word Mimo comes from Korea. Translated simply, it means beautiful me. As a company that deals largely in the health and beauty sectors, the identity for Mimo needed to embody a style and philosophy that is simple, elegant, and modern.",
                    media: [{
                        type: "image",
                        src: "/images/work/mimo/mimo1.jpg",
                        size: [1200, 500]
                    }, {
                        type: "image",
                        src: "/images/work/mimo/mimo2.jpg",
                        size: [1200, 500]
                    }, {
                        type: "image",
                        src: "/images/work/mimo/o3.jpg",
                        size: [1200, 606]
                    }]
                }, {
                    slug: "flyleaf",
                    ...
                    category: "Motion",
                    role: "Art Direction &amp; Design",
                    poster: ["/images/work/flyleaf/poster.jpg", "/images/work/flyleaf/feature.jpg"],
                    description: "When the opportunity arose to create a music video for the popular band Flyleaf, it sounded like an exciting endeavor that would surely push my creative skills and offer new and interesting challenges. The band came to us with a concept already in mind. From there, it was up to me and a small team of other designers to sketch, build, and fully realize what they were looking to acheive. My role involved art direction, pre-visualization, storyboarding, and building all of the assets and environments. From there, they were passed on to my colleagues and animated. The reaction from both the band and their large fan base has been very positive. The video has amassed close to two million views on youtube since it's premier in 2013.",
                    credits: [{
                        copy: "Direction",
                        name: "Brad Scott - Definite Productions"
                    }, {
                        copy: "Motion Graphics",
                        name: "Patty Toner"
                    }],
                    media: [{
                        type: "video",
                        id: "64095720",
                        src: "/images/work/flyleaf/flyleaf-video-poster.jpg",
                        size: [1280, 720]
                    }, {
                        type: "image",
                        src: "/images/work/flyleaf/flyleaf01.jpg",
                        size: [1200, 670]
                    }, {
                        type: "image",
                        src: "/images/work/flyleaf/flyleaf02.jpg",
                        size: [1200, 500]
                    }, {
                        type: "image",
                        src: "/images/work/flyleaf/flyleaf03.jpg",
                        size: [1200, 454]
                    }, {
                        type: "image",
                        ...
                        type: "image",
                        src: "/images/work/flyleaf/flyleaf05.jpg",
                        size: [1200, 550]
                    }, {
                        type: "image",
                        src: "/images/work/flyleaf/flyleaf06.jpg",
                        size: [1200, 550]
                    }, {
                        type: "image",
                        src: "/images/work/flyleaf/flyleaf07.jpg",
                        size: [1200, 550]
                    }, {
                        type: "image",
                        src: "/images/work/flyleaf/flyleaf08.jpg",
                        size: [1200, 550]
                    }]
                }]
            }
    ...
    return t = e.safe = function(e) {
        ...
        function() {
            (function() {
                ...
                for (i.push('\n        </div>\n      </div>\n    </div>\n    <div id="ac-roller" class="roller">\n      <div class="roller-inner">\n        <div class="roller-part">\n          <div class="lava-link passage" data-href="/about"><h4>About / Contact<span class="tick"></span></h4></div>\n        </div>\n        <div class="roller-part">\n          <div class="lava-link passage" data-href="/"><h4>Home<span class="tick"></span></h4></div>\n        </div>\n      </div>\n    </div>\n    <div id="pi-roller" class="roller">\n      <div class="roller-inner">\n        <div class="roller-part">\n          <div class="lava-link passage" data-href="/"><h4>View Index<span class="tick right"></span></h4></div>\n        </div>\n        <div class="roller-part">\n          <div class="lava-link"><h4>Hide Index<span class="tick right"></span></h4></div>\n        </div>\n      </div>\n    </div>\n  </div>\n  <div id="control">\n    <span></span>\n    <span></span>\n  </div>\n  <div id="project-index">\n    <div id="project-index-inner">\n      <ul>\n        '), d = this.pages.work, e = r = 0, l = d.length; l > r; e = ++r) m = d[e], i.push('\n          <li style="height: '), i.push(s(100 / this.pages.work.length)), i.push('%;">\n            <h3><span>'), i.push(("000" + (e + 1)).slice(-3)), i.push(" - </span>"), i.push(m.title), i.push("</h3>\n          </li>\n        ");
